...
//            } else if (tipo == 1) {
            individuoNuevo = new EstudianteNormal(new BST<>(null));
...
//            }
    ...
    public void eliminarRecursos() {
        ...
        ListaSimple<Recursos> listaDel = new ListaSimple<>();

        for (int i = 0; i < numRecursos; i++) {
            Recursos recurso = DatosCompartidos.getListaRecursos().getDato(i);
    ...
    private void eliminarRecursos(ListaSimple<Recursos> listaDel){
    ...
    public void eliminarIndividuos() {
        ...
        ListaSimple<Estudiante> listaDel = new ListaSimple<>();
    ...
    private void moverIndividuosCuadrado(ListaSimple<Square> listaCuadrados, Square cuadrado, ListaSimple<Integer> listaID) {
        ListaSimple<Estudiante> individuosMovidosCuadrado = new ListaSimple<>(); // Se crea una lista donde se van a meter los individuos que esten en el cuadrado que ya se hayan movido
        while (!cuadrado.getIndividuos().isVacia()) {
            Estudiante ind = cuadrado.getIndividuos().getPrimero();
    ...
    private void moverIndNormal(ListaSimple<Square> listaCuadrados, Square cuadrado, Individuo ind) {
        EstudianteNormal indNormal = (EstudianteNormal) ind;
    ...
    private void buscarNuevoObjetivo(ListaSimple<Square> listaCuadrados, Square cuadrado, IndNormal ind) {
        ...
        Recursos objetivo = DatosCompartidos.getListaRecursos().getDato(recursoRandom);
    ...
    private boolean individuoYaMovido(Estudiante ind, ListaSimple<Integer> lista) {
        int contador = 0;
    ...
    public void actualizarProbabilidades() {
        ListaSimple<Estudiante> indTotales = DatosCompartidos.getListaIndividuos();
        for (int i = 0; i < indTotales.getNumeroElementos(); i++) {
            Estudiante actual = indTotales.getDato(i);
