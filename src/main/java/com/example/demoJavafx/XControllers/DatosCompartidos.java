...
public class DatosCompartidos {
    ...
    public static ListaSimple<Recursos> getListaRecursos() {
        return listaRecursos;
    }

    public static void setListaRecursos(ListaSimple<Recursos> listaRecursos) {
    ...
    public static void setGame(BucleDeControl game) {
