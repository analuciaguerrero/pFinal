...
class EstudianteNormalTest {
    private EstudianteNormal estudiante;
    ...
    void setUp() {
        ...
        celda = new Celda();
        tablero = new Tablero();
        estudiante = new EstudianteNormal(1, 0, 0, 1, 100, 50, 30, 1);
    }

    @Test
    void testConstructorCopia() {
        EstudianteNormal estudianteCopia = new EstudianteNormal(estudiante);
    ...
    void testConstructorConPosicion() {
        EstudianteNormal estudianteConPosicion = new EstudianteNormal(1, 0, 0, 1, 100, 50, 30, 1);
    ...
    void testConstructorSinPosicion() {
        EstudianteNormal estudianteSinPosicion = new EstudianteNormal(2, 1, 100, 50, 30, 1);
    ...
    void testConstructorVacio() {
        EstudianteNormal estudianteVacio = new EstudianteNormal();
        assertNotNull(estudianteVacio);
    }

    @Test
    void testGetTipo() {
        assertEquals(EstudianteNormal.class, estudiante.getTipo());
    }
    ...
    @Test
    void testSetPadres() {
        Estudiante padre1 = new EstudianteNormal(2, 1, 0, 1, 100, 50, 30, 1);
        Estudiante padre2 = new EstudianteNormal(3, 1, 0, 1, 100, 50, 30, 1);
    ...
    void testReproducirse() {
        Estudiante pareja = new EstudianteNormal(2, 1, 0, 1, 100, 50, 30, 1);
