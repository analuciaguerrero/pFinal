...
class EstudianteBasicoTest {
    ...
    void testConstructorConPosicion() {
        EstudianteBasico estudianteConPosicion = new EstudianteBasico(1, 0, 0, 1, 100, 50, 30, 1);
    ...
    void testConstructorSinPosicion() {
        EstudianteBasico estudianteSinPosicion = new EstudianteBasico(2, 1, 100, 50, 30, 1);
    ...
    void testConstructorVacio() {
        EstudianteBasico estudianteVacio = new EstudianteBasico();
    ...
    @Test
    void testSetPadres() {
        Estudiante padre1 = new EstudianteBasico(2, 1, 0, 1, 100, 50, 30, 1);
        Estudiante padre2 = new EstudianteBasico(3, 1, 0, 1, 100, 50, 30, 1);
    ...
    void testReproducirse() {
        Estudiante pareja = new EstudianteBasico(2, 1, 0, 1, 100, 50, 30, 1);
